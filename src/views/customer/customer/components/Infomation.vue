    ...
    <el-card>
        <el-row>
            ...
            <el-col :span="12">
                <el-button
                    ...
                    @click="$router.push(`/customer/customer/edit/${$route.params.id}`)"
                    type="primary"
                    size="small"
                >Sửa</el-button>
            </el-col>
        ...
        <el-row>
            <el-col :span="12">
                ...
                <el-row class="item">
                    <el-col :span="12">
                        <p class="my-label">Khách hàng cha</p>
                    </el-col>
                    <el-col :span="12">
                        <p class="content">{{ data.parent}}</p>
                    </el-col>
                </el-row>
                <el-row class="item">
                    <el-col :span="12">
            ...
            <el-col :span="12">
                ...
                <el-row class="item">
                    <el-col :span="12">
                        <p class="my-label">Đánh giá</p>
                    </el-col>
                    <el-col :span="12">
                        <p class="content">{{ data.evaluate }}</p>
                    </el-col>
                </el-row>
                <el-row class="item">
                    <el-col :span="12">
                ...
                <el-row class="item">
                    <el-col :span="12">
                        <p class="my-label">Tổng số nhân viên</p>
                    </el-col>
                    <el-col :span="12">
