        ...
        <el-col :span="24">
            <el-row>
                ...
                <el-col :offset="isShow?0:21" :span="3">
                    <el-button v-if="isEdit" @click="updateCustomer" type="success" class="fr">Lưu</el-button>
                    <el-button
                        v-else-if="isShow"
                        size="medium"
                        @click="$router.push(`/customer/customer/edit/${form.id}`)"
                        type="primary"
                        class="fr"
                    >Sửa</el-button>
                    <el-button
...
export default {
    ...
    created() {
        ...
        if (this.isEdit || this.isShow) this.getCustomer();
    }
};
</script>
