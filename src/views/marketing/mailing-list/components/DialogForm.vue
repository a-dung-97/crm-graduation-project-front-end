<template>
    <el-dialog
        width="30%"
        center
        :title="this.editing ? 'Chỉnh sửa danh sách email': 'Thêm danh sách email'"
...
<script>
import { store, update } from "@/api/marketing/mailing-list";
export default {
        ...
        return {
            ...
            rules: {
                name: [
                    {
                        required: true,
                        message: "Hãy nhập tên danh sách email",
                        trigger: "blur"
                    }
                ]
            }
